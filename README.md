...
- 🔭 Je travaille actuellement sur un [Système de référendum](https://github.com/killianrms/SAE-Votes) pour l'université et un [Bot de trading](https://github.com/killianrms/prototype_trader_bot) en projet perso.
